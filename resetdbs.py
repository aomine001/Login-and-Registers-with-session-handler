...
sql = 'CREATE TABLE session (ip varchar(2048) NOT NULL, uuid varchar(2048) NOT NULL, user varchar(65535) NOT NULL, banned varchar(8) NOT NULL);' #uuid = user unique id log n pwd
